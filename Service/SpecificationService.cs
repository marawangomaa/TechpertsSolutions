...
namespace Service
{
    public class SpecificationService : ISpecificationService
    {
        ...
        public async Task<
            GeneralResponse<IEnumerable<Core.DTOs.SpecificationsDTOs.SpecificationDTO>>
        > GetAllSpecificationsAsync()
        {
            try
            {
                ...
                return new GeneralResponse<
                    IEnumerable<Core.DTOs.SpecificationsDTOs.SpecificationDTO>
                >
                {
                    Success = true,
        ...
        public async Task<
            GeneralResponse<Core.DTOs.SpecificationsDTOs.SpecificationDTO>
        > GetSpecificationByIdAsync(string id)
        {
            ...
            try
            {
                ...
                var spec = await _specRepo.GetByIdWithIncludesAsync(
                    id,
                    s => s.Product,
                    s => s.Product.Category,
                    s => s.Product.SubCategory,
        ...
        public async Task<
            GeneralResponse<IEnumerable<Core.DTOs.SpecificationsDTOs.SpecificationDTO>>
        > GetSpecificationsByProductIdAsync(string productId)
        {
        ...
        public async Task<
            GeneralResponse<Core.DTOs.SpecificationsDTOs.SpecificationDTO>
        > CreateSpecificationAsync(CreateSpecificationDTO createDto)
        {
        ...
        public async Task<GeneralResponse<bool>> UpdateSpecificationAsync(
            UpdateSpecificationDTO updateDto
        )
        {
        ...
        public async Task<
            GeneralResponse<IEnumerable<ProductListItemDTO>>
        > GetProductsBySpecificationAsync(string key, string value)
        {
        ...
        public async Task<
            GeneralResponse<IEnumerable<ProductListItemDTO>>
        > GetProductsBySpecificationIdAsync(string specificationId)
        {
            ...
            var specifications = await _specRepo.FindAsync(s =>
                s.Key == specification.Key && s.Value == specification.Value
            );
            var productIds = specifications.Select(s => s.ProductId).Distinct().ToList();
