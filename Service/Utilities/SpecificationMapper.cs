...
namespace Service.Utilities
{
    ...
    {
        public static Core.DTOs.SpecificationsDTOs.SpecificationDTO MapToSpecificationDTO(
        ...
        public static Specification MapToSpecification(
            UpdateSpecificationDTO dto,
            Specification existingSpecification
        )
        {
            if (dto == null || existingSpecification == null)
                return null;
        ...
        public static IEnumerable<Core.DTOs.SpecificationsDTOs.SpecificationDTO> MapToSpecificationDTOList(
            IEnumerable<Specification> specifications
        )
        {
            if (specifications == null)
                return Enumerable.Empty<Core.DTOs.SpecificationsDTOs.SpecificationDTO>();
