...
namespace Service
{
    public class LocationService : ILocationService
    {
        ...
        public (double Lat, double Lon) GetMidpoint(
            double lat1,
            double lon1,
            double lat2,
            double lon2
        ...
        public double CompanyToCustomer(
            double companyLat,
            double companyLon,
            double customerLat,
            double customerLon
        ...
        public double DriverToCustomer(
            double driverLat,
            double driverLon,
            double customerLat,
            double customerLon
