...
namespace Core.Interfaces.Services
{
    public interface ICartService
    {
        ...
        Task<string> UpdateItemQuantityAsync(
            string customerId,
        ...
        Task<GeneralResponse<OrderReadDTO>> PlaceOrderAsync(
            string customerId,
        ...
        Task<GeneralResponse<CartReadDTO>> AddPCBuildToCartAsync(
            string assemblyId,
            decimal total,
            decimal assemblyFee
        );
        ...
        Task<GeneralResponse<object>> InitiatePaymentAsync(
            string customerId,
            string currency = "usd"
        );
    }
